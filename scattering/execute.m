...
for k=0.025:0.025:0.25  
    ...
    flag0.plotsub(h,2,5,1,T_x,T_sc(:,1),T_sc(:,2), 'Xlabel','¦È_2 (pi)','Ylabel','|t^L_{u-d}|^2 and |t^L_{d-u}|^2','title',sprintf('Prob vs. ¦È_2'),'Y1legend',sprintf('UD-E_{inc}=%0.3feV',k),'Y2legend',sprintf('DU-E_{inc}=%0.3feV',k),'save','true','clear','false');
