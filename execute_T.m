...
Tmean=Ie/I;
T_l=interp1(T_x,(1:1:20000)',(miu_t));
T_l=floor(T_l);
T_r=interp1(T_x,(1:1:20000)',(miu_b));
T_r=ceil(T_r);
...
for i=1999:-1:12
    ...
    T_l1=interp1(T_x,(1:1:20000)',(miu_t1));T_l2=interp1(T_x,(1:1:20000)',(miu_t2));
    T_l1=floor(T_l1);T_l2=floor(T_l2);
    T_r1=interp1(T_x,(1:1:20000)',(miu_b1));T_r2=interp1(T_x,(1:1:20000)',(miu_b2)');
    T_r1=ceil(T_r1);T_r2=ceil(T_r2);
    El_delta=(miu_t2-miu_t1);Er_delta=(miu_b2-miu_b1);
    
    T_num0=deltaI*1e43;
    T_num1=mean(Tdost_deb(T_r1:T_r2,:).*T_deb(T_r1:T_r2,:))*Er_delta;  %*Er_delta
    T_den=mean(Tdost_deb(T_l1:T_l2,:))*El_delta;   %*El_delta
    Tmean=(T_num0+T_num1)/T_den;
...
for i=11:1:1990
    ...
    T_num0=deltaI*1e43;
    T_num1=mean(Tdost_deb(T_l1:T_l2,:).*T_deb(T_l1:T_l2,:))*El_delta;
    T_den=mean(Tdost_deb(T_r1:T_r2,:))*Er_delta;
    Tmean=(T_num0+T_num1)/T_den;
    T_deb1(T_r1:T_r2,1)=Tmean;
end
%}

%
figure(2)
s=plot(T_x,T_deb1,T_x,Tdost_deb/1e34);  %m,Tdost_deb*1e10
title('Tunneling probability');
xlabel('Fermi Level (eV)');
ylabel('T(E)');
saveas(gcf,sprintf('C:\\Users\\cwhypt\\Documents\\MATLAB\\pic\\0.T(E)_Vb_%0.2f.jpg',6));
pause(3)
%}
